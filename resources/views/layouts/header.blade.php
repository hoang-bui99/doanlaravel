        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <!-- logo -->
                    <img width="80px" src="{{ asset('image/logo.png') }}" alt="">
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown dropdown">
                                <button type="button" class="btn btn-light dropbtn" id="navbarDropdown">
                                {{ Auth::user()->name }}
                                </button>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-content" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('categories.index') }}">Category Page</a>
